...
Route::middleware([ForceJsonResponse::class, SetApiLocale::class, 'throttle:api'])->group(function (): void {
    ...
    Route::middleware(['cookie_csrf', UseSanctumTokenFromCookie::class, 'auth:sanctum', 'active_mutation'])->group(function (): void {
        ...
        Route::prefix('admin')->middleware('admin')->group(function (): void {
            ...
            Route::get('/users', [AdminUserModerationController::class, 'index'])->middleware('admin_mfa');
            Route::post('/users', [UserController::class, 'store'])->middleware('admin_mfa');
            ...
            Route::get('/stats', AdminStatsController::class)->middleware('admin_mfa');
            Route::get('/reports', [ReportController::class, 'index'])->middleware('admin_mfa');
            Route::patch('/reports/{report}/status', [ReportController::class, 'updateStatus'])->middleware('admin_mfa');
            Route::get('/moderation-actions', [AdminModerationActionController::class, 'index'])->middleware('admin_mfa');
            Route::get('/reviews', [AdminReservationReviewController::class, 'index'])->middleware('admin_mfa');
            ...
            Route::get('/privacy/delete-requests', [DataDeletionRequestController::class, 'adminIndex'])->middleware('admin_mfa');
            ...
            Route::get('/professional-verifications', [ProfessionalVerificationController::class, 'adminIndex'])->middleware('admin_mfa');
            Route::get('/professional-verifications/{professionalVerification}/document', [ProfessionalVerificationController::class, 'downloadDocument'])
            ...
            Route::get('/animals/review', [AdminAnimalReviewController::class, 'index'])->middleware('admin_mfa');
            Route::patch('/animals/{animal}/legal-status', [AdminAnimalReviewController::class, 'updateStatus'])->middleware('admin_mfa');
            Route::get('/orders', [AdminOrdersController::class, 'index'])->middleware('admin_mfa');
            Route::get('/moderation', [AdminModerationController::class, 'index'])->middleware('admin_mfa');
            Route::get('/moderation/{type}', [AdminModerationController::class, 'marketplaceSection'])->middleware('admin_mfa');
